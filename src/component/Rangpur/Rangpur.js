            ...
            return (
                <>
                    ...
                    <tr className="bg-black bg-opacity-20">
                        ...
                        <td className="px-3 py-3">{el.sehriHour} : {el.sehriMinutes + 3} {el.sehriTime}</td>
                        <td className="px-3 py-3">{el.iftarHour} : {el.iftarMinutes + 5} {el.iftarTime}</td>
                    </tr>
    ...
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="min-w-full text-sm text-gray-400">
            <thead className="bg-gray-800 text-xs uppercase font-medium">
                <tr>
                    <th scope="col" className="px-3 py-3">Ramadan</th>
                    <th scope="col" className="px-3 py-3">Date</th>
                    <th scope="col" className="px-3 py-3">Day</th>
                    <th scope="col" className="px-3 py-3">Sehri Last Time</th>
                    {/* <th scope="col" className="px-3 py-3">Fazar Waqt Start</th> */}
                    <th scope="col" className="px-3 py-3">Iftar Time</th>
                </tr>
            </thead>
